    ...
    StoreT: Store,
{
    ...
    pub fn vertex_from_bindings(&mut self, vertex: bindings::Vertex) -> Result<Vertex, PluginError> {
        Ok(Vertex {
            instance: Instance {
    ...
    pub fn edge_from_bindings(&mut self, edge: bindings::Edge) -> Result<Edge, PluginError> {
        Ok(Edge {
            instance: Instance {
                id: edge.id.try_into()?,
    ...
    pub fn property_from_bindings(&mut self, property: bindings::Property) -> Result<Property, PluginError> {
        Ok(Property {
    ...
    /// Convert metadata to bindings.
    pub fn metadata_from_bindings(&mut self, metadata: Resource<BindingsMap>) -> Result<Metadata, PluginError> {
...
) -> Result<EventHandlers, PluginError> {
